...
class B_model():
    ...
    def bert_model(self):
        ...
        prompt = "agent0 go to north-west, agent1 go to north-west, agent2 go to north-west"
        # prompt = "All agent go to north-west"
...
class A2CAgent:
    def __init__(self, no_agent,state_size, action_size):
        ...
        self.critic1 = Critic((no_agent*(self.state_size)+self.text_size), self.value_size, self.critic_lr).to(device)
    ...
    def train_model(self, state,log_prob0,log_prob1,log_prob2,sin_stage_reward, next_state,b_hid_st, done,e):
        ...
        next_value_pt = self.critic(next_state_tensor_b)[0]
...
if __name__ == "__main__":
    ...
    critic1_save_path="model/critic1.pkl"   
